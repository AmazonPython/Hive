...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="order-bottom">
                        ...
                        <div class="order-summary text-end">
                            <!-- 展示优惠信息开始 -->
                            @if($order->couponCode)
                                <div class="line text-primary">
                                    <span class="line-label">优惠信息：</span>
                                    <div class="line-value">{{ $order->couponCode->description }}</div>
                                </div>
                            @endif
                            <!-- 展示优惠信息结束 -->
                            <div class="line">
                                <div class="line-label">订单总价：</div>
                                <div class="line-value">￥{{ $order->total_amount }}</div>
                            </div>
                            <div class="line">
                            ...
                            @endif
                            <div class="receive-button mt-2 me-2">
    ...
    <!-- 分期弹框开始 -->
    <div class="modal fade" tabindex="-1" id="installment-modal" aria-hidden="true">
